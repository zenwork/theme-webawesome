  ...
  "node_modules/mark.js/dist/mark.js"(exports, module) {
    (function(global, factory) {
      ...
      var DOMIterator = (function() {
        ...
        __name(DOMIterator2, "DOMIterator2");
        createClass(DOMIterator2, [{
          key: "getContexts",
          value: /* @__PURE__ */ __name(function getContexts() {
          ...
          value: /* @__PURE__ */ __name(function getIframeContents(ifr, successFn) {
          ...
          key: "isIframeBlank",
          value: /* @__PURE__ */ __name(function isIframeBlank(ifr) {
            var bl = "about:blank", src = ifr.getAttribute("src").trim(), href = ifr.contentWindow.location.href;
            return href === bl && src !== bl && src;
          }, "isIframeBlank")
        }, {
          key: "observeIframeLoad",
          value: /* @__PURE__ */ __name(function observeIframeLoad(ifr, successFn, errorFn) {
            var _this = this;
          ...
          key: "onIframeReady",
          value: /* @__PURE__ */ __name(function onIframeReady(ifr, successFn, errorFn) {
            try {
          ...
          key: "waitForIframes",
          value: /* @__PURE__ */ __name(function waitForIframes(ctx, done) {
            var _this2 = this;
            var eachCalled = 0;
          ...
          key: "forEachIframe",
          value: /* @__PURE__ */ __name(function forEachIframe(ctx, filter, each) {
            var _this3 = this;
            ...
            var checkEnd = /* @__PURE__ */ __name(function checkEnd2() {
              if (--open <= 0) {
                end(handled);
              }
            }, "checkEnd2");
          ...
          key: "createIterator",
          value: /* @__PURE__ */ __name(function createIterator(ctx, whatToShow, filter) {
            return document.createNodeIterator(ctx, whatToShow, filter, false);
          }, "createIterator")
        }, {
          key: "createInstanceOnIframe",
          value: /* @__PURE__ */ __name(function createInstanceOnIframe(contents) {
            return new DOMIterator2(contents.querySelector("html"), this.iframes);
          }, "createInstanceOnIframe")
        }, {
          key: "compareNodeIframe",
          value: /* @__PURE__ */ __name(function compareNodeIframe(node, prevNode, ifr) {
          ...
          key: "getIteratorNode",
          value: /* @__PURE__ */ __name(function getIteratorNode(itr) {
          ...
          value: /* @__PURE__ */ __name(function checkIframeFilter(node, prevNode, currIfr, ifr) {
          ...
          value: /* @__PURE__ */ __name(function handleOpenIframes(ifr, whatToShow, eCb, fCb) {
            var _this4 = this;
          ...
          value: /* @__PURE__ */ __name(function iterateThroughNodes(whatToShow, ctx, eachCb, filterCb, doneCb) {
            var _this5 = this;
            var itr = this.createIterator(ctx, whatToShow, filterCb);
            var ifr = [], elements = [], node = void 0, prevNode = void 0, retrieveNodes = /* @__PURE__ */ __name(function retrieveNodes2() {
          ...
          key: "forEachNode",
          value: /* @__PURE__ */ __name(function forEachNode(whatToShow, each, filter) {
            var _this6 = this;
            ...
            contexts.forEach(function(ctx) {
              var ready = /* @__PURE__ */ __name(function ready2() {
          ...
          key: "matches",
          value: /* @__PURE__ */ __name(function matches(element, selector) {
      ...
      var Mark$1 = (function() {
        ...
        createClass(Mark3, [{
          key: "log",
          value: /* @__PURE__ */ __name(function log(msg) {
          ...
          key: "escapeStr",
          value: /* @__PURE__ */ __name(function escapeStr(str) {
            return str.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
          }, "escapeStr")
        }, {
          key: "createRegExp",
          value: /* @__PURE__ */ __name(function createRegExp(str) {
          ...
          value: /* @__PURE__ */ __name(function createSynonymsRegExp(str) {
          ...
          key: "processSynomyms",
          value: /* @__PURE__ */ __name(function processSynomyms(str) {
            if (this.opt.ignoreJoiners || this.opt.ignorePunctuation.length) {
              str = this.setupIgnoreJoinersRegExp(str);
            }
            return str;
          ...
          value: /* @__PURE__ */ __name(function setupWildcardsRegExp(str) {
          ...
          value: /* @__PURE__ */ __name(function createWildcardsRegExp(str) {
            var spaces = this.opt.wildcards === "withSpaces";
            return str.replace(/\u0001/g, spaces ? "[\\S\\s]?" : "\\S?").replace(/\u0002/g, spaces ? "[\\S\\s]*?" : "\\S*");
          }, "createWildcardsRegExp")
        }, {
          key: "setupIgnoreJoinersRegExp",
          value: /* @__PURE__ */ __name(function setupIgnoreJoinersRegExp(str) {
          ...
          }, "setupIgnoreJoinersRegExp")
        }, {
          key: "createJoinersRegExp",
          value: /* @__PURE__ */ __name(function createJoinersRegExp(str) {
            var joiner = [];
          ...
          value: /* @__PURE__ */ __name(function createDiacriticsRegExp(str) {
          ...
          value: /* @__PURE__ */ __name(function createMergedBlanksRegExp(str) {
            return str.replace(/[\s]+/gmi, "[\\s]+");
          }, "createMergedBlanksRegExp")
        }, {
          key: "createAccuracyRegExp",
          value: /* @__PURE__ */ __name(function createAccuracyRegExp(str) {
            var _this = this;
            var chars = "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~\xA1\xBF";
          ...
          value: /* @__PURE__ */ __name(function getSeparatedKeywords(sv) {
            var _this2 = this;
            var stack = [];
          ...
          key: "isNumeric",
          value: /* @__PURE__ */ __name(function isNumeric(value) {
            return Number(parseFloat(value)) == value;
          }, "isNumeric")
        }, {
          key: "checkRanges",
          value: /* @__PURE__ */ __name(function checkRanges(array) {
            var _this3 = this;
          ...
          value: /* @__PURE__ */ __name(function callNoMatchOnInvalidRanges(range, last) {
          ...
          value: /* @__PURE__ */ __name(function checkWhitespaceRanges(range, originalLength, string) {
          ...
          key: "getTextNodes",
          value: /* @__PURE__ */ __name(function getTextNodes(cb) {
            var _this4 = this;
            var val = "", nodes = [];
          ...
          key: "matchesExclude",
          value: /* @__PURE__ */ __name(function matchesExclude(el) {
            return DOMIterator.matches(el, this.opt.exclude.concat(["script", "style", "title", "head", "html"]));
          }, "matchesExclude")
        }, {
          key: "wrapRangeInTextNode",
          value: /* @__PURE__ */ __name(function wrapRangeInTextNode(node, start, end) {
          ...
          value: /* @__PURE__ */ __name(function wrapRangeInMappedTextNode(dict, start, end, filterCb, eachCb) {
            var _this5 = this;
          ...
          key: "wrapMatches",
          value: /* @__PURE__ */ __name(function wrapMatches(regex, ignoreGroups, filterCb, eachCb, endCb) {
            var _this6 = this;
          ...
          value: /* @__PURE__ */ __name(function wrapMatchesAcrossElements(regex, ignoreGroups, filterCb, eachCb, endCb) {
            var _this7 = this;
            var matchIdx = ignoreGroups === 0 ? 0 : ignoreGroups + 1;
            this.getTextNodes(function(dict) {
              var match = void 0;
          ...
          value: /* @__PURE__ */ __name(function wrapRangeFromIndex(ranges, filterCb, eachCb, endCb) {
            var _this8 = this;
            this.getTextNodes(function(dict) {
          ...
          key: "unwrapMatches",
          value: /* @__PURE__ */ __name(function unwrapMatches(node) {
          ...
          value: /* @__PURE__ */ __name(function normalizeTextNode(node) {
            if (!node) {
              return;
            }
            if (node.nodeType === 3) {
          ...
          key: "markRegExp",
          value: /* @__PURE__ */ __name(function markRegExp(regexp, opt) {
            var _this9 = this;
            this.opt = opt;
            this.log('Searching with expression "' + regexp + '"');
            var totalMatches = 0, fn = "wrapMatches";
            var eachCb = /* @__PURE__ */ __name(function eachCb2(element) {
              totalMatches++;
          ...
          key: "mark",
          value: /* @__PURE__ */ __name(function mark(sv, opt) {
            var _this10 = this;
            this.opt = opt;
            var totalMatches = 0, fn = "wrapMatches";
            var _getSeparatedKeywords = this.getSeparatedKeywords(typeof sv === "string" ? [sv] : sv), kwArr = _getSeparatedKeywords.keywords, kwArrLen = _getSeparatedKeywords.length, sens = this.opt.caseSensitive ? "" : "i", handler = /* @__PURE__ */ __name(function handler2(kw) {
          ...
          key: "markRanges",
          value: /* @__PURE__ */ __name(function markRanges(rawRanges, opt) {
            var _this11 = this;
            this.opt = opt;
          ...
          key: "unmark",
          value: /* @__PURE__ */ __name(function unmark(opt) {
            var _this12 = this;
            this.opt = opt;
          ...
          set: /* @__PURE__ */ __name(function set$$1(val) {
            this._opt = _extends({}, {
              ...
              "ignorePunctuation": [],
              "wildcards": "disabled",
              "each": /* @__PURE__ */ __name(function each() {
              }, "each"),
              "noMatch": /* @__PURE__ */ __name(function noMatch() {
              }, "noMatch"),
              "filter": /* @__PURE__ */ __name(function filter() {
                return true;
              }, "filter"),
              "done": /* @__PURE__ */ __name(function done() {
              }, "done"),
              "debug": false,
              "log": window.console
            }, val);
...
var _a;
var PagefindHighlight = (_a = class {
  constructor(options = {
    markContext: null,
    ...
    (_a2 = this.markOptions).className ?? (_a2.className = "pagefind__highlight");
...
}, __name(_a, "PagefindHighlight"), _a);
