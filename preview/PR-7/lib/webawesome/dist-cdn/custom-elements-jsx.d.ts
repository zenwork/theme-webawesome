 ...
 * - `--show-duration`: The duration of the expand animation. (default: `200ms`)
 * - `--hide-duration`: The duration of the collapse animation. (default: `200ms`)
 * - `--easing`: The easing of the expand/collapse animation. (default: `ease`)
 * - `--wa-accordion-divider-color`: The color of the divider between accordion items. (default: `var(--wa-color-surface-border)`)
 * 
 * #### CSS Parts
 * 
 * Custom selectors for styling elements within the component.
...
export type CustomCssProperties = {
  ...
  "--wa-accordion-divider-color"?: string;
