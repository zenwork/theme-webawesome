...
Stable [Utilities](https://webawesome.com/docs/components/?category=utilities) [Since 2.0](https://webawesome.com/docs/resources/changelog#wa_200)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.8.0/components/animation/animation.js';
```
...
Using `<wa-animation>` with SSR

Because the animation uses the JS API to start / stop animations, this component will SSR properly and not cause layout shift, but it will not play its animation until the component loads.
