...
Experimental [Utilities](https://webawesome.com/docs/components/?category=utilities) [Since 3.4](https://webawesome.com/docs/resources/changelog#wa_340)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.8.0/components/markdown/markdown.js';
```
...
Using `<wa-markdown>` with SSR

Because `<wa-markdown>` relies on the content of its children, it is not usable in an SSR context which does not have a DOM.
