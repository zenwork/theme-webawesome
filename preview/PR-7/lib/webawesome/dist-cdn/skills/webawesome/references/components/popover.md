...
Stable [Utilities](https://webawesome.com/docs/components/?category=utilities) [Since 3.0](https://webawesome.com/docs/resources/changelog#wa_300)
...
```js
import 'https://ka-f.webawesome.com/webawesome@3.8.0/components/popover/popover.js';
```
