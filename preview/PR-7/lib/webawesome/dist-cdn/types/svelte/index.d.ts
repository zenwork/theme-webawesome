...
export type CustomElements = {
   ...
   * - **--show-duration** - The duration of the expand animation. _(default: 200ms)_
   * - **--hide-duration** - The duration of the collapse animation. _(default: 200ms)_
   * - **--easing** - The easing of the expand/collapse animation. _(default: ease)_
   * - **--wa-accordion-divider-color** - The color of the divider between accordion items. _(default: var(--wa-color-surface-border))_
   *
   * ### **CSS Parts:**
