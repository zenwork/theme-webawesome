...
| --- | --- | --- |
| \`checked\` | \`boolean\` Draws the checkbox in a checked state. Type | | |
...
| \`name\` name | \`string\` The name of the checkbox, submitted as a name/value pair with form data. Type Default '' | | |
